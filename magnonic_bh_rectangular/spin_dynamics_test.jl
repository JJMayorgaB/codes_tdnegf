...
# Dos bloques rectangulares 5×3 (5 en x, 3 en y) desde y=7 e y=0, centrados en x=7.
const REMOVED_0BASED = vcat(
    [(x, y) for x in 5:9 for y in 5:7],   # bloque 5×3 superior
    [(x, y) for x in 5:9 for y in 0:2],   # bloque 5×3 inferior
)
...
function run_kT(kT, J)
    ...
    # Valores al final de la relajación: es el estado con el que arranca la
    # etapa de driving, no un promedio de cola.
